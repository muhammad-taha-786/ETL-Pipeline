...
def extract(url, table_attribute):
    ...
    log_progress("Data Extraction Completed. Initiating Data Transformation.")
    return df

def trasform(df, csv_path):
    ...
    log_progress("Data Transformation Completed. Initiating Loading Process.")
...
if __name__ == "__main__":
    ...
    df = ic(extract(url, "By market capitalization"))  # Extraction
    trasform(df, "./input/exchange_rate.csv")
